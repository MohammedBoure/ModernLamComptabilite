(() => {
  ...
  function renderReportMetadata(dataset, printDate) {
    const rows = [
      ...
      { label: "User", value: currentUserDisplayName() },
      ...
      <div class="report-preview">
        <div class="report-title">
          <div>
            ...
            <span>${escapeHtml(settings.labName)}</span><br>
            <span>NIF: ${escapeHtml(settings.nif)} | RIP: ${escapeHtml(settings.rip)}</span>
          </div>
          <div>
            <strong>${escapeHtml(reportPeriodLabel())}</strong><br>
            <span>Print date: ${escapeHtml(printDate)}</span><br>
            <span>User: ${escapeHtml(currentUserDisplayName())}</span><br>
      ...
      <div class="report-preview">
        <div class="report-title">
          ...
          <div>
            ...
            <span>Generated by ${escapeHtml(currentUserDisplayName())} - ${escapeHtml(new Date().toLocaleDateString())}</span><br>
            <span>Draft / Official prototype preview</span>
          </div>
        </div>
