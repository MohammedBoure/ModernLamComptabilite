...
function documentationCoverage() {
  return [
    ...
    },
    {
      ...
      prototypeCoverage: "Employee identity, contracts, leave balances, documents, attendance and salary links are represented as sections.",
      status: "Partially Covered",
      followUp: "Convert the employee file into tabs and add function/status/contract/search filters.",
    },
    {
      source: "accounting/ui/02",
...
function coverageFollowUpTasks() {
  return [
    ...
    ["Medium", "HR interfaces", "Convert employee file content to tabs and add HR list filters for function, status, contract, and search.", "Planned"],
