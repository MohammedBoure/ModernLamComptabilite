...
هذا الملف يجمع القواعد الحسابية والمنطقية التي يجب تنفيذها. بعض القواعد مؤكدة من التقرير، وبعضها مقترح ويحتاج تأكيد.
...
هذه الصيغة تحتاج تأكيد لأنها تبدو وكأن `Caisse C` مكررة. يجب سؤال الإدارة هل المقصود:
