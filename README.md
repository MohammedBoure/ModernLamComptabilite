...
التوثيق الفعلي منظم حسب اللغة. النسخة العربية هي النسخة التفصيلية المعتمدة حاليا، بينما تبقى النسختان الفرنسية والإنجليزية مخصصتين للترجمة والتطوير اللاحق.
...
| Francais | [docs/fr/README.md](./docs/fr/README.md) | نسخة مخصصة للترجمة لاحقا |
| English | [docs/en/README.md](./docs/en/README.md) | نسخة مخصصة للترجمة لاحقا |
...
تتوفر التفاصيل الكاملة للواجهات، سير العمل، القواعد الحسابية، قاعدة البيانات، وخطة التنفيذ ضمن [التوثيق العربي](./docs/ar/README.md).
